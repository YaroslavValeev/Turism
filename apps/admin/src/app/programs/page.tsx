  ...
  return (
    <main className="mw-admin-page mw-admin-page--wide">
      <AdminPageHeader
        ...
        description={
          <>
            По умолчанию — <strong>очередь модерации</strong> (не архив и не сайт). Чтобы программа появилась на сайте и в
            Telegram, нужен статус <strong>«Опубликована»</strong>; «Одобрена» только про проверку. Фокус каталога —{" "}
            <strong>{PILOT_SCOPE_LABEL}</strong>.
          </>
        }
      />
