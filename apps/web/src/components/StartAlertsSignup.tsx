    ...
    <div className="mw-card mw-alerts-signup">
      ...
      <form onSubmit={onSubmit} className="mw-alerts-signup__form">
        ...
        <div className="mw-alerts-signup__consent">
          ...
          <Link href="/privacy-and-consent" prefetch={false}>
            Политика и согласие
          </Link>
        </div>
      </form>
      {error && (
        <p id="alerts-signup-feedback" className="mw-alerts-signup__error" role="alert">
          {error}
        </p>
      )}
      {success && (
        <p id="alerts-signup-feedback" className="mw-alerts-signup__success" role="status" aria-live="polite">
          {success}
        </p>
      )}
