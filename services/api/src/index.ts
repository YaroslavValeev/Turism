...
import { telegramWebhookRoutes } from "./modules/telegram/webhookRoutes";
...
import { campsV1Router } from "./routes/camps.v1";
...
app.use("/public/telegram", publicRateLimiter, telegramWebhookRoutes(env));
